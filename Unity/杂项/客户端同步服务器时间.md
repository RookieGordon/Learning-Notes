...
{  
    ...
    public static void InitializeServerTime(long serverTimestamp, string serverIanaTimeZoneId)  
    {        
        ...
        DateTime serverUtcTime = DateTimeOffset.FromUnixTimeSeconds(serverTimestamp).UtcDateTime;  
