...
$$\begin{align}
p_{i} & = \Delta x(d_{1}-d_{0})\\ & = 2\Delta y(x_{i} + 1) - (2y_{i} - 1 + 2b)\Delta x \\ & = 2\Delta yx_{i}-2\Delta xy_{i} + 2(\Delta y + 2b\Delta x - \Delta x)
\end{align}$$
...
有：p_{i + 1} & = 2\Delta y(x_{i}+ 1)-2\Delta xy_{i} + 2(\Delta y + 2b\Delta x - \Delta x)
\end{align}$$
